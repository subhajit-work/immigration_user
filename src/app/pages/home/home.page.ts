...
export class HomePage implements OnInit, OnDestroy {
  ...
  private getWhoWeAreSubscribe: Subscription;
  private getServiceAssuredSubscribe: Subscription;
  private getTestimonialsSubscribe: Subscription;
  private getNewsSubscribe: Subscription;
  getServiceContact_api;
  getWhoWeAre_api;
  getServiceAssured_api;
  getTestimonials_api;
  getNewsContact_api;
  homeLoadData;
  homePageData;
  ...
  serviceData:any;
  newsData:any;
  getBanner_api: string;
  getBannerSubscribe: Subscription;
  banner: any;
  get_who_we_are;
  get_Service_Assured;
  get_Testimonials;
  ...
  ionViewWillEnter() {
    ...
    // getWhoWeAre api
    this.getWhoWeAre_api = 'get-who-we-are';
    this.getWhoWeAre();

    // getServiceAssured api
    this.getServiceAssured_api = 'get-service-assured';
    this.getServiceAssured();

    // getTestimonials api
    this.getTestimonials_api = 'get-testimonials';
  ...
  getBanner(){
    ...
    this.getBannerSubscribe = this.http.get(this.getBanner_api).subscribe(
      (res:any) => {
      this.selectLoadingDepend = false;
      this.banner = res.return_data;
  ...
  //getWhoWeAre
  getWhoWeAre(){
    this.getWhoWeAreSubscribe = this.http.get(this.getWhoWeAre_api).subscribe(
      (res:any) => {
      this.get_who_we_are =res.return_data;
      console.log('get_who_we_are', res);
    },
    errRes => {
    }
    );
  ...
  //getServiceAssured
  getServiceAssured(){
    this.getServiceAssuredSubscribe = this.http.get(this.getServiceAssured_api).subscribe(
      (res:any) => {
      this.get_Service_Assured =res.return_data;
      console.log('get_Service_Assured', res);
    },
    errRes => {
    }
    );
  ...
  //getTestimonials
  getTestimonials(){
    this.getTestimonialsSubscribe = this.http.get(this.getTestimonials_api).subscribe(
      (res:any) => {
      this.get_Testimonials =res;
      console.log('get_Testimonials', res);
    },
    errRes => {
    }
    );
  ...
  ngOnDestroy() {
    ...
    if(this.getWhoWeAreSubscribe !== undefined){
      this.getWhoWeAreSubscribe.unsubscribe();
    }
    if(this.getServiceAssuredSubscribe !== undefined){
      this.getServiceAssuredSubscribe.unsubscribe();
    }
    if(this.getTestimonialsSubscribe !== undefined){
      this.getTestimonialsSubscribe.unsubscribe();
    }
