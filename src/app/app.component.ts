    ...
    .pipe(
      ...
      this.userInfoSubscribe = this.http.get('footer').subscribe(
        ...
        if(response.return_status > 0){
          ...
          // fabicon set
          this._document.getElementById('appFavicon').setAttribute('href', response.return_data.data.path+'fabicon/'+response.return_data.data.fab_icon);
          console.log('appFavicon', response.return_data.data.path+'fabicon/'+response.return_data.data.fab_icon);
